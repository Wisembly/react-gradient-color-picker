...
exports.useDropper = void 0;
var react_1 = require("react");
var html2canvas_1 = __importDefault(require("html2canvas"));
var tinycolor2_1 = __importDefault(require("tinycolor2"));
var useDropper = function (onSelect) {
    var _a = (0, react_1.useState)(null), pickerCanvas = _a[0], setPickerCanvas = _a[1];
    var _b = (0, react_1.useState)(false), coverUp = _b[0], setCoverUp = _b[1];
    var _c = (0, react_1.useState)(false), isPicking = _c[0], setIsPicking = _c[1];
